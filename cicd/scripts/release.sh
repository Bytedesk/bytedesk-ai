...
###
 ...
 # @Date: 2024-08-29 11:14:30
 # @LastEditors: jackning 270580156@qq.com
 # @LastEditTime: 2024-08-31 14:51:23
...
### 
# 不上传app/embedings，因为太大且无更改
# 本地路径（这里添加了多个文件和文件夹）
FILES_TO_UPLOAD=("app" "cicd" "static" "main.py" ".env.prod" "poetry.lock" "pyproject.toml" "readme.md" "readme.zh.md" "readme-ubuntu.md" "start.sh" "stop.sh")
# 服务器地址
